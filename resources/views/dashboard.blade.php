        ...
        <div class="flex flex-wrap gap-4">
            ...
            <div class="w-72 bg-gray-900 border border-gray-800 rounded-xl p-5 relative"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        <h3 class="text-white font-semibold text-base">{{ config('app.name') }}</h3>
                    ...
                    <div class="relative">
                        ...
                        <div x-show="terminalMenu" @click.outside="terminalMenu = false" x-transition
                            ...
                            <a href="#" class="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition">
                ...
                {{-- Open Session Button --}}
                <button class="w-full py-2 px-4 bg-orange-500 hover:bg-orange-400 text-white text-sm font-semibold rounded-lg transition">
                    Open Session
                </button>
            </div>
