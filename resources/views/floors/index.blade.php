                ...
                <div class="flex items-center gap-2">
                    ...
                    <div x-show="selectedTables.length > 0" x-transition class="flex items-center gap-2">
                        ...
                        <form method="POST" action="{{ route('floors.tables.bulk-destroy', $floor) }}">
                            ...
                            <button type="submit" onclick="return confirm('Delete selected tables?')"
                    ...
                    <form method="POST" action="{{ route('floors.destroy', $floor) }}"
                          onsubmit="return confirm('Delete floor {{ addslashes($floor->name) }} and all its tables?')">
                        @csrf @method('DELETE')
                        <button type="submit"
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition">
                                    ...
                                    <form method="POST" action="{{ route('floors.tables.destroy', [$floor, $table]) }}"
                                          onsubmit="return confirm('Delete table {{ addslashes($table->number) }}?')">
                                        @csrf @method('DELETE')
